...
##
##### Script aim: #####
#' Meta-regressions to assess publication bias in lnCVR (presented in section iv of the manuscript)
#' 
##
##
...
## small-study effects
model_pub_bias1 <- rma.mv(yi = lnCVR, 
                          V = lnCVR.sv, 
                          mods = ~ 1 +
                            sqrt_inv_eff_ss, 
...
## time lag effects
model_pub_bias2 <- rma.mv(yi = lnCVR, 
                          V = lnCVR.sv, 
                          mods = ~ 1 +
                            publication_year_c, 
                          random = list(~1|study_ID,
