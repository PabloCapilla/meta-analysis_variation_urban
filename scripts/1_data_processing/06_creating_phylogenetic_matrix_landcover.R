...
##
##### Script aim: #####
#' This script creates a matrix of phylogenetic correlation to include in land cover meta-analytical models of lnCVR
#' 
##
##
##
...
##### data #####
##
data <- readRDS("./data/processed_RDS_data_files/metaanalysis_full_data_landcover.RDS")
head(data)
...
saveRDS(phylo_cor, file = "./data/processed_RDS_data_files/phylogenetic_correlations_lancover_model.RDS")
